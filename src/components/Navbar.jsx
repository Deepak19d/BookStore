...
function Navbar() {
  ...
  <div className="navbar-center hidden lg:flex">
    ...
    <label className= "px-3 py-2 border rounder-md flex items-center gap-2">
  ...
  <div className="">
    <a className="bg-black text-white p-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer">Login</a>
  </div>
</div>
</div>
   </div>
